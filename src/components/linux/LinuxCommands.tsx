        ...
        <div style={{ margin: 15 }}>
            ...
            <Collapse defaultActiveKey={[ '0' ]}>
                <Panel header='View the souce code' key='1'>
                    ...
                    />
                    <br />
                    <Button href="https://gist.githubusercontent.com/Cyb3rHq/6f3838dc02f46b14e9dbc9bc0972407e/raw/8c29317645df2e1d39777e95df8cf7760458d4d0/misconfiguration.sh" target='blank' type='primary' style={{ marginBottom: 10, marginTop: 15 }}>
